...
public class RecordLight {
    ...
    public static final HSBColorType.HSBColor HSV_COLOR_ORANGE = HSBColorType.HSBColor.newBuilder().setHue(60).setSaturation(1d).setBrightness(1d).build();
    public static final HSBColorType.HSBColor HSV_COLOR_YELLOW = HSBColorType.HSBColor.newBuilder().setHue(100).setSaturation(1d).setBrightness(1d).build();
    ...
    public static final long RECORD_LIGHT_TIMEOUT = 3000;
